...
interface FeedbackSucessSteepProps {
    onFeedbackRestartRequested: () => void;
  }

export function FeedbackSucessSteep({onFeedbackRestartRequested}: FeedbackSucessSteepProps) {
    return (
        <>
            <header>
                <CloseButton/>
            ...
            <button
                ...
                className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-emerald-700 transition-colors disabled:opacity-50 disabled:hover:bg-emerald-700"
            >
                Quero enviar outro
            </button>
            </div>
